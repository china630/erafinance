...
import { mountCustomsCaptureInjection } from "../src/connectors/customs/injection";

export default defineContentScript({
  matches: ["https://e-customs.gov.az/*", "https://*.customs.gov.az/*"],
  runAt: "document_idle",
  async main(_ctx) {
    ...
    root.render(
      <StrictMode>
        <FloatingWidget erpActiveOrganization={erpActiveOrganization} flow="customs" />
      </StrictMode>,
    );
